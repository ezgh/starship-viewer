...
const CommonCard = ({ url, name, model, hyperdriveRating }) => {
  ...
  return (
    <li className="m-5 p-5">
      ...
      >
        <div className="relative p-8 pt-40 text-white bg-black group bg-opacity-40 hover:bg-opacity-0">
          ...
          <h3 className="opacity-0 absolute text-2xl text-starWarsYellow font-bold top-5 right-5 group-hover:opacity-100">
            Learn more
          </h3>
        </div>
      </Link>
